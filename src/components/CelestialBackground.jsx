...
You can combine with existing ones, just ensure names are unique.
...
@keyframes shooting-star {
  ...
  10% { opacity: 1; }
  80% { opacity: 1; }
  100% { transform: translateX(500px) scaleX(1.5); opacity: 0; } /* Longer, faster trail 
}

@keyframes drift {
  0%, 100% { transform: translate(0, 0) scale(1); opacity: 0.7; }
  25% { transform: translate(20px, -10px) scale(1.04); opacity: 0.8; }
  50% { transform: translate(-25px, 15px) scale(0.96); opacity: 0.6; }
  75% { transform: translate(10px, -18px) scale(1.03); opacity: 0.75; }
}
